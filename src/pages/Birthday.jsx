      ...
      <div className="row">
        ...
        <div className="col-md-4 mb-4">
          <div className="card border-none shadow">
            ...
            />
            <div className="card-body">
              <h5 className="card-title text-center">Birthday Balloons</h5>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4 mb-4">
          <div className="card border-none shadow">
            ...
            />
            <div className="card-body">
              <h5 className="card-title text-center">Event Managements</h5>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-4 mb-4">
          <div className="card border-none shadow">
            ...
            />
            <div className="card-body">
              <h5 className="card-title text-center">Gifts Purchasing</h5>
            </div>
          </div>
        </div>
