...
function Birtheve() {
    ...
    return (
        ...
        style={{
            backgroundImage: 'url("https://png.pngtree.com/thumb_back/fw800/background/20231023/pngtree-happy-birthday-image_13943660.jpg")',
    ...
    >
        ...
        {/* Event cards section */}
        <div className="container mt-5 text-dark" id='bg'>
